  ...
  return createPortal((
    <div className="fixed inset-0 z-100 flex items-center justify-center p-4">
      ...
      <div className={`relative glass-card w-full ${maxWidth || 'max-w-md'} rounded-2xl overflow-hidden animate-in fade-in zoom-in duration-300`}>
        ...
        <button 
          onClick={onClose}
          className="absolute top-5 right-5 p-2 rounded-full bg-white text-slate-400 shadow-sm border border-slate-200 hover:text-slate-900 transition-colors z-10"
        >
